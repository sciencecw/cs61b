...
public class TriangleTest {
   ...
   **/
    ...
    public void testEquilateral() {
      //TODO: FILL IN
        Triangle t1 = new Triangle(35, 35, 35);
        String result = t1.triangleType();
    ...
    public void testIsosceles() {
        Triangle t = new Triangle(40, 40, 50);
        String result = t.triangleType();
    ...
    public void testInvalid() {
        Triangle t = new Triangle(30, 40, 90);
        String result = t.triangleType();
    ...
    public void testNegative() {
        Triangle t = new Triangle(40, 40, -1);
        String result = t.triangleType();
